...
# ==========================================
# 1. Source Inject: quant kernel (dependency for _mxfp4_quant_op inside preshuffle GEMM)
# ==========================================
...
# ==========================================
# 2. Source inject: preshuffle config files for ALL our benchmark shapes
# ==========================================
import json

CONFIGS_DIR = '/home/runner/aiter/aiter/ops/triton/configs/gemm'

# Tuned configs with aggressive NUM_KSPLIT for our benchmark shapes
# Benchmark shapes: (M,N,K) = (4,2880,512), (16,2112,7168), (32,4096,512), (32,2880,512), (64,7168,2048), (256,3072,1536)
# Config lookup uses K_real for naming: gfx950-GEMM-A16WFP4_PRESHUFFLED-N={N}-K={K_real}.json

SHAPE_CONFIGS = {
    # K=512: small K, no split needed, aggressive tile for low latency
    "gfx950-GEMM-A16WFP4_PRESHUFFLED-N=2880-K=512.json": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "num_warps": 8, "num_stages": 1, "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg", "NUM_KSPLIT": 1},
    ...
    # K=7168: aggressive K-split (from aiter tuned config: NUM_KSPLIT=14)
    # Already exists: gfx950-GEMM-A16WFP4_PRESHUFFLED-N=2112-K=7168.json with NUM_KSPLIT=14
    # K=2048: M=64 has 4*56=224 tiles — enough for 304 CUs, reduce split
    "gfx950-GEMM-A16WFP4_PRESHUFFLED-N=7168-K=2048.json": {
        "M_LEQ_8": {"BLOCK_SIZE_M": 8, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg", "NUM_KSPLIT": 4},
        "M_LEQ_16": {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "num_warps": 4, "num_stages": 2, "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg", "NUM_KSPLIT": 4},
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": None, "NUM_KSPLIT": 1},
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": None, "NUM_KSPLIT": 1},
    },
    # K=1536: M=256 has 192 tiles (enough CUs), NO split needed; small M needs split
    "gfx950-GEMM-A16WFP4_PRESHUFFLED-N=3072-K=1536.json": {
        "M_LEQ_8": {"BLOCK_SIZE_M": 8, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "num_warps": 4, "num_stages": 1, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg", "NUM_KSPLIT": 6},
        "M_LEQ_16": {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 512, "GROUP_SIZE_M": 1, "num_warps": 4, "num_stages": 1, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg", "NUM_KSPLIT": 6},
        ...
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "num_warps": 8, "num_stages": 2, "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": None, "NUM_KSPLIT": 1},
    },
}

# Write config files + quant files + clear caches
try:
...
# ==========================================
# 3. Entry point — best of v31b+v31c: ASM fallback + manual preshuffle configs
# ==========================================
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if M >= 128 and K <= 2048:
        # ---- ASM path: M=256/K=1536 (18.1μs vs preshuffle 20.7μs) ----
        A = A.contiguous()
    ...
    # ---- Preshuffle fused quant+GEMM with manual config (skip JSON lookup) ----
    A = A.contiguous()
    ...
    # Per-shape tuned configs (from v31c, proven on MI355X)
    if K <= 512:
        cfg = {
        ...
        # K=7168: aggressive K-split (from aiter tuned config)
        cfg = {
    ...
    return gemm_a16wfp4_preshuffle(A, w, w_scales, config=cfg, dtype=torch.bfloat16)
