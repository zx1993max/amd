...
SHAPE_CONFIGS = {
    # K=512: BSK=512, waves=2 (from v37b)
    ...
    # M=16/K=7168: BSN=256 (auto_search) + BSK=256 + stages=2
    ...
    # M=64/K=2048: BSK=256 + stages=2 + waves=2 (v37b+v38 combined!)
    ...
    # M=256/K=1536: BSK=256 + stages=2 + waves=1 (try even lower occupancy)
    "gfx950-GEMM-A16WFP4_PRESHUFFLED-N=3072-K=1536.json": {
        ...
        "M_LEQ_256": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "num_warps": 8, "num_stages": 2, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg", "NUM_KSPLIT": 1},
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "num_warps": 8, "num_stages": 2, "waves_per_eu": 1, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg", "NUM_KSPLIT": 1},
    },
}
