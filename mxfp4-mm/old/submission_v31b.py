...
# ==========================================
# 3. Entry point — hybrid: preshuffle + ASM fallback for M=256/K=1536
# ==========================================
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if M >= 128 and K <= 2048:
        # ---- ASM path: M=256/K=1536 preshuffle is slower (20.7 vs 18.3μs) ----
        A = A.contiguous()
        ...
        # ---- Preshuffle fused quant+GEMM (all other shapes) ----
        ...
        return gemm_a16wfp4_preshuffle(A.contiguous(), w, w_scales, dtype=torch.bfloat16)
