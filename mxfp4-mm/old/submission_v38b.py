...
# ==========================================
# 2. Inject config files — BSK=256 + num_stages=2 for large K
# ==========================================
CONFIGS_DIR = '/home/runner/aiter/aiter/ops/triton/configs/gemm'

SHAPE_CONFIGS = {
    # K=512: keep BSK=512 (only 1 K iteration, BSK=256 would double iterations for no benefit)
    ...
    # M=16/K=7168: BSK=256 + stages=2 → 2 pipelined K iterations per split (was 1 with BSK=512)
    "gfx950-GEMM-A16WFP4_PRESHUFFLED-N=2112-K=7168.json": {
        "M_LEQ_32": {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg", "NUM_KSPLIT": 14},
    ...
    # M=64/K=2048: BSK=256 + stages=2 → 8 pipelined K iterations (was 4 with BSK=512)
    "gfx950-GEMM-A16WFP4_PRESHUFFLED-N=7168-K=2048.json": {
        ...
        "M_LEQ_64": {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 128, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 1, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": ".cg", "NUM_KSPLIT": 1},
        "any": {"BLOCK_SIZE_M": 32, "BLOCK_SIZE_N": 256, "BLOCK_SIZE_K": 256, "GROUP_SIZE_M": 4, "num_warps": 8, "num_stages": 2, "waves_per_eu": 4, "matrix_instr_nonkdim": 16, "cache_modifier": None, "NUM_KSPLIT": 1},
    },
    # M=256/K=1536: ALL preshuffle with BSK=256 + stages=2 → 6 pipelined K iterations
    # (was ASM at 18.1μs — try preshuffle with better pipelining)
...
# ==========================================
# 4. Entry point — ALL preshuffle, no ASM fallback
# ==========================================
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Convert B formats for preshuffle kernel
    ...
    # All shapes use preshuffle with skip_reduce
